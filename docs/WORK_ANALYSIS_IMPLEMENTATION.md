...
| `frontend/src/features/video-analysis/VideoAnalysis.tsx` | 作品分析页面 |
...
| 端点 | 方法 | 说明 |
|------|------|------|
| `/work/analyze` | POST | 同步分析视频 |
| `/work/analyze/async` | POST | 异步提交任务 |
| `/work/tasks/{id}` | GET | 获取任务结果 |
| `/work/tasks/{id}/progress` | GET | 获取任务进度 |
| `/work/tasks` | GET | 列出所有任务 |
| `/work/capabilities` | GET | 获取支持能力 |
