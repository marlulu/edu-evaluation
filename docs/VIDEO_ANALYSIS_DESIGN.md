...
```python
# ai-worker/app/modules/content_parsing/video/metadata.py
...
```python
# ai-worker/app/modules/content_parsing/video/keyframes.py
...
```python
# ai-worker/app/modules/content_parsing/video/subtitles.py
...
```python
# ai-worker/app/modules/content_parsing/video/content_analyzer.py
...
```python
# 创建视频解析任务
POST /api/content-parsing/video/tasks
{
    "file_id": "xxx",
    "file_name": "demo.mp4",
    "options": {
...
# 查询任务状态
GET /api/content-parsing/video/tasks/{task_id}

# 获取解析结果
GET /api/content-parsing/video/tasks/{task_id}/result

# 获取关键帧
GET /api/content-parsing/video/tasks/{task_id}/keyframes/{frame_id}

# 获取转录文本
GET /api/content-parsing/video/tasks/{task_id}/transcription
```
